...
import edit from '../assets/profile.png';
    ...
    return (
              ...
              <div className="bg-white h-16 justify-between items-center mx-auto px-4 flex">
                ...
                <div className="md:space-x-6 justify-end items-center ml-auto flex space-x-3">
                  ...
                  <div className="ml-[100px]">
                    <p className="transform cursor-pointer hover:scale-110 transition duration-700 text-cyan-400">Day Cruise</p>
                    {/* notification symbol */}
                    {/* <p className="pt-1 pr-1 pb-1 pl-1 bg-white text-gray-700 rounded-full transition-all duration-200
                  hover:text-gray-900 focus:outline-none hover:bg-gray-100">
                      <span className="justify-center items-center flex">
                  ...
                  <p className="transform cursor-pointer hover:scale-110 transition duration-700 text-cyan-400">Houseboats</p>
                  <p className="transform cursor-pointer hover:scale-110 transition duration-700 text-cyan-400">Special Cruises</p>
      ...
      <div className="relative" ref={menuRef}>
        <div className="cursor-pointer" onClick={() => setOpen(!open)}>
          <img src={user} alt="User" className="h-10 mr-[20px] transform hover:scale-110 transition duration-700" />
        </div>

        <div className={`absolute right-0 mt-2 mr-[150px] bg-cyan-100 z-50 shadow-lg rounded-md ${open ? 'block' : 'hidden'}`}>
          <div className="p-4">
          <img src={user} alt="User" className="h-10 transform hover:scale-110 transition duration-700" />
            <h3 className=" mb-1 mr-[100px] text-gray-700 font-bold">Marrie Currie</h3>
            {/* <div className="flex items-center mt-[67px] justify-center"> */}
          <hr className="border-t-2 border-gray-300 w-54" />
        {/* </div> */}
...
function DropdownItem(props) {
  return (
    <li className="flex items-center p-2 w-[250px] cursor-pointer hover:bg-blue-300">
      <img src={props.img} alt="Dropdown Icon" className="h-6  w-6 mr-2" />
      
      <a className="text-sm  text-gray-800">{props.text}</a>
      {/* <img src={arrow} alt="Dropdown Icon" className="h-6  w-6 ml-[100px]" /> */}
    </li>
  );
}
